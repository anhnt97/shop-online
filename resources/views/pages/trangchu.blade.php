            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            @foreach($sale_product as $sale_item)
                            <div class="col-sm-3" style="padding-bottom: 15px">
                                <div class="single-item">
                                    <div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>

                                    <div class="single-item-header">
                                        <a href="{{route('chitietsanpham',$sale_item->id)}}"><img src="source/image/product/{{$sale_item->image}}" height="250px" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$sale_item->name}}</p>
                                        <p class="single-item-price">
                                                <span class="flash-del">{{$sale_item->unit_price}}đ</span>
                                                <span class="flash-sale">{{$new_item->promotion_price}}đ</span>
                                        </p>
                                    </div>
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="{{route('themgiohang',$sale_item->id)}}"><i class="fa fa-shopping-cart"></i></a>
                                        <a class="beta-btn primary" href="{{route('chitietsanpham',$sale_item->id)}}">Chi tiết <i class="fa fa-chevron-right"></i></a>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
