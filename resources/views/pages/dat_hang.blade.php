                        ...
                        <div class="your-order-body" style="padding: 0px 10px">
                            ...
                            <div class="your-order-item">
                                <div>
                                    ...
                                    <div class="media">
                                        <img width="25%" src="source/image/product/{{$product_item['item']['image']}}" alt="" class="pull-left">
                                        <div class="media-body">
                                            <p class="font-large">{{$product_item['item']['name']}}</p>
                                            <span class="color-gray your-order-info">Số lượng: {{$product_item['qty']}}</span>
                                            <span class="color-gray your-order-info">Đơn giá: {{$product_item['price']}}</span>
                                        </div>
                                    </div>
                                    <!-- end one item -->
                                    @endforeach
                            ...
                            @else
                                <div class="your-order-item text-center">Bạn chưa có đơn hàng nào!</div>
                            @endif
                        </div>
